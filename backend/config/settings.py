"""
Django settings for the HireAI platform.
"""
...
DATABASES = {
    "default": {
        ...
        "NAME": config("POSTGRES_DB", default="hireai"),
        "USER": config("POSTGRES_USER", default="hireai"),
        "PASSWORD": config("POSTGRES_PASSWORD", default="hireai"),
...
# Celery (for async resume parsing / interview generation)
